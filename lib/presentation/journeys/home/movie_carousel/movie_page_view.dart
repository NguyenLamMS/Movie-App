...
class _MoviePageViewState extends State<MoviePageView> {
  ...
  void initState() {
    super.initState();
    _pageController = PageController(initialPage: widget.initialPage, keepPage: false, viewportFraction: 0.7);
  }
    ...
    return Container(
      ...
      child: PageView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return AnimatedMovieCardWidget(movieId: movie.id, posterPath: movie.posterPath, pageController: _pageController, index: index,);
        },
        pageSnapping: true,
