...
import 'package:movieapp/presentation/widget/movie_app_bar.dart';
import 'package:movieapp/presentation/widget/separator.dart';
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        MovieBackdropWidget(),
        Column(
          children: [MovieAppBar(), MoviePageView(movies: movies, initialPage: defaultIndex), MovieDataWidget(), Separator()],
        ),
      ],
    );
  }
