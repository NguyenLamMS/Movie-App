...
class SearchMovieCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Padding(
        padding: EdgeInsets.symmetric(horizontal: Sizes.dimen_16.w, vertical: Sizes.dimen_2.h),
        child: Row(
          children: [
            Padding(
              ...
              child: ClipRRect(
                ...
                child: CachedNetworkImage(
                  imageUrl: movie.posterPath != null ? '${ApiConstants.BASE_IMAGE_URL}${movie.posterPath}' : '${ApiConstants.IMAGE_NOT_FOUND}',
